...
<div id="pageintro"><a class="btn" href="produk.php"><< Kembali</a></div>
<center>
...
<!-- Advance Search -->
 ...
 <td><a href="produk_edit.php?id_produk=<?php echo $produk['id_produk']; ?>">Edit</a><td><a href="produk_hapus_proses.php?id_produk=<?php echo $produk['id_produk']; ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>
 </tr>
			<?php }?>
		</table>
		<?php
