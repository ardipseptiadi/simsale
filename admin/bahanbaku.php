...
<!-- Advance Search -->
 ...
 <td><a href="bahanbaku_edit.php?id_bahanbaku=<?php echo $buff['id_bahanbaku']; ?>">Edit</a>
 <!--<td><a href="bahanbaku_hapus_proses.php?id_bahanbaku=<?php echo $buff['id_bahanbaku']; ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>-->
 </tr>
			<?php }?>
		</table>
		<?php
