...
<html>
<head>
<title>RADJA SALE - Hapus Data</title>
<meta charset="utf-8">
...
<center>
<?php
echo"<h2>Data Telah dihapus</h2>";
?>
<div id="aksi2" class="center">
<?php
include("koneksi.php");
mysql_query("DELETE from bahanbaku WHERE id_bahanbaku='$_GET[id_bahanbaku]'");
