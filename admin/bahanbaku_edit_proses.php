...
error_reporting(0);
   $id_bahanbaku = $_POST['id_bahanbaku'];
	 ...
	 $stok_bahanbaku = $_POST['stok_bahanbaku'];
	 $satuan_bahanbaku = $_POST['satuan_bahanbaku'];

                 $query = mysql_query("UPDATE bahanbaku SET nama_bahanbaku='$nama_bahanbaku', stok_bahanbaku='$stok_bahanbaku', satuan_bahanbaku='$satuan_bahanbaku' WHERE id_bahanbaku='$id_bahanbaku'");
?>
<center>
<?php
...
<?php
echo"<div id='pageintro'><a class='btn' href=\"bahanbaku.php\">Kembali</a>";
?>
</div>
</center>
