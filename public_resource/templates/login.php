...
<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      <div class="modal-header">
		  ...
		  <div align="center"><img width="100px" src="images/header_logo.png"></div>
          <h1 class="text-center">Login CV. Radja Sale</h1>
      </div>
      <div class="modal-body">
          <form class="form col-md-12 center-block" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            ...
            <!-- <div class="form-group">
              <select class="form-control input-lg" placeholder="akses" id="akses" name="akses" >
              	<option value="admin"> ADMIN </option>
                <option value="gudang"> MANAJER GUDANG </option>
								<option value="pengadaan"> MANAJER PENGADAAN </option>

              </select>
            </div> -->
          <div class="form-group">
              <button class="btn btn-primary btn-lg btn-block">Log In</button>
              <!--<span class="pull-right"><a href="daftar.php">Register</a></span><span><a href="lupapassword.php">Lupa Password</a></span>-->
            </div>
          </form>
      </div>
