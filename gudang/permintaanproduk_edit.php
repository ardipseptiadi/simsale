...
<?php
	...
	<center>
	<h3>Edit Data Permintaan Produk</h3>
	<p><a href="permintaanproduk.php"><< Kembali</a> / <a href="home.php">Beranda</a></p>
...
$query = "SELECT * FROM permintaanproduk WHERE id_permintaan='$id_permintaan'";
...
<body>
<form name="form1" method="post" action="permintaanproduk_edit_proses.php">
<table>
<tr>
	<td>ID PPermintaan</td>
	<td bgcolor="lightgrey"><input type="text" name="id_permintaan" readonly value="<?php echo $buff['id_permintaan']; ?>"></td>
</tr>

<tr>
	<td>Bulan</td>
	<td bgcolor="lightgrey"><input type="text" name="bulan_permintaan" value="<?php echo $buff['bulan_permintaan']; ?>"></td>
</tr>
<tr>
	<td>Jumlah</td>
	<td bgcolor="lightgrey"><input type="text" name="jumlah_permintaan" value="<?php echo $buff['jumlah_permintaan']; ?>"></td>
</tr>
<tr>
	<td>ID Produk</td>
	<td bgcolor="lightgrey"><input type="text" name="id_produk" readonly value="<?php echo $buff['id_produk']; ?>"></td>
</tr>
