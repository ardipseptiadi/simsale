...
<html>
<head>
<title>RADJA SALE - Permintaan Produk</title>
<meta charset="utf-8">
       ...
       <nav id="mainav" class="fl_right">
          <ul class="clear">
            ...
            <li ><a class="drop" href="#">Data Master</a>
			  ...
			  <li class="active"><a href="permintaanproduk.php">Permintaan Produk</a></li>
            <li><a href="peramalan.php">Peramalan</a></li>
...
<div class="wrapper row2">
  <div id="breadcrumb" class="clear"> 
    ...
    <ul>
	  ...
	  <li><a href="permintaanproduk.php">Data Permintaan Produk</a></li>
...
?>  
<?php
echo '<h1>Data Permintaan Produk</h1>'
?>
<div id="aksi" class="fl_right">
<div id="pageintro"><a class="btn" href="permintaanproduk_tambah.php">Tambah Data</a></div>
<center>
...
<!-- form quick search -->
<form name="form1" method="post" action="permintaanproduk_cari.php">
...
if(isset($_POST['q']) && $_POST['q']){
	...
	$q = $_POST['q'];
	$sql = "select * from permintaanproduk where id_permintaan like '%$q%' or bulan_permintaan like '%$q%' or jumlah_permintaan like '%$q%' or id_produk like '%$q%'";
...
<!-- Advance Search -->
	...
	if(mysql_num_rows($result) > 0){
        ...
        <table>
			...
			<?php
			while($permintaanproduk = mysql_fetch_array($result)){?>
			<tr align="center">
 <td><?php echo $permintaanproduk['id_permintaan']; ?></td>
 <td><?php echo $permintaanproduk['bulan_permintaan']; ?></td>
 <td><?php echo $permintaanproduk['jumlah_permintaan']; ?></td>
 <td><?php echo $permintaanproduk['id_produk']; ?></td>
 <td><a href="permintaanproduk_edit.php?id_permintaan=<?php echo $buff['id_permintaan']; ?>">Edit</a><td><a href="permintaanproduk_hapus_proses.php?id_permintaan=<?php echo $buff['id_permintaan']; ?>" onclick="javascript: return confirm('Anda yakin akan menghapus data ini ?')">Hapus</a></td>
 </tr>
			<?php }?>
		</table>
		<?php
...
$tampil = "SELECT * FROM permintaanproduk";
...
<tr align="center">
 <td><?php echo $buff['id_permintaan']; ?></td>
 <td><?php echo $buff['bulan_permintaan']; ?></td>
 <td><?php echo $buff['jumlah_permintaan']; ?></td>
 <td><?php echo $buff['id_produk']; ?></td>
 <td><a href="permintaanproduk_edit.php?id_permintaan=<?php echo $buff['id_permintaan']; ?>">Edit</a>
 <td><a href="permintaanproduk_hapus_proses.php?id_permintaan=<?php echo $buff['id_permintaan']; ?>" onclick="javascript: return confirm('Anda yakin akan menghapus data ini ?')">Hapus</a></td>
 </tr>
