...
<div id="pageintro"><a class="btn" href="permintaanproduk.php"><< Kembali</a></div>
<center>
...
<!-- Advance Search -->
	...
	if(mysql_num_rows($result) > 0){
        ...
        <table>
			...
			<?php
			while($produk = mysql_fetch_array($result)){?>
			<tr align="center">
 ...
 <td><a href="permintaanproduk_edit.php?id_permintaan=<?php echo $permintaanproduk['id_permintaan']; ?>">Edit</a>
 <td><a href="permintaanproduk_hapus_proses.php?id_permintaanproduk=<?php echo $permintaaproduk['id_permintaanproduk']; ?>" onclick="javascript: return confirm('Anda yakin akan menghapus data ini ?')">Hapus</a></td>
 </tr>
			<?php }?>
		</table>
		<?php
