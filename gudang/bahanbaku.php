...
<br>
<!--<div id="pageintro"><a class="btn" href="bahanbaku_tambah.php">Tambah Data</a></div>-->
<center>
...
<!-- Advance Search -->
 ...
 <!--<td><a href="bahanbaku_edit.php?id_bahanbaku=<?php echo $buff['id_bahanbaku']; ?>">Edit</a><td><a href="bahanbaku_hapus_proses.php?id_bahanbaku=<?php echo $buff['id_bahanbaku']; ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>-->
 </tr>
			<?php }?>
		</table>
		<?php
...
<tr align="center">
 <td><?php echo $buff['id_bahanbaku']; ?></td>
 <td><?php echo $buff['nama_bahanbaku']; ?></td>
 <td><?php echo $buff['stok_bahanbaku']; ?></td>
 <td><?php echo $buff['satuan_bahanbaku']; ?></td>
 <!--<td><a href="bahanbaku_edit.php?id_bahanbaku=<?php echo $buff['id_bahanbaku']; ?>">Edit</a><td><a href="bahanbaku_hapus_proses.php?id_bahanbaku=<?php echo $buff['id_bahanbaku']; ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>-->
 </tr>
