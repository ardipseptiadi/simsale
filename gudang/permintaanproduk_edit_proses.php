...
error_reporting(0);
   $id_permintaan = $_POST['id_permintaan'];
     $bulan_permintaan = $_POST['bulan_permintaan'];
	 $jumlah_permintaan = $_POST['jumlah_permintaan'];
	 $id_produk = $_POST['id_produk'];

                 $query = mysql_query("UPDATE permintaanproduk SET bulan_permintaan='$bulan_permintaan', jumlah_permintaan='$jumlah_permintaan' WHERE id_permintaan='$id_permintaan'");
?>
<center>
<?php
echo "<h2>Data Telah diubah</h2>";
?>
<div id="aksi2" class="center">
<?php
echo"<div id='pageintro'><a class='btn' href=\"permintaanproduk.php\">Kembali</a>";
?>
</div>
</center>
