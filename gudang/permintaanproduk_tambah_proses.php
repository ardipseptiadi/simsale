...
if(isset($_POST['tambah'])){
	...
	$id_produk		= $_POST['id_produk'];	//membuat variabel $nama dan datanya dari inputan Nama Lengkap
	$nama_produk		= $_POST['nama_produk'];	//membuat variabel $nama dan datanya dari inputan Nama Lengkap
	
	//melakukan query dengan perintah INSERT INTO untuk memasukkan data ke database
	$input = mysql_query("INSERT INTO produk VALUES('$id_produk', '$nama_produk')") or die(mysql_error());
?>	
<center>
<?php
...
<?php
		echo "<div id='pageintro'><a class='btn' href=\"produk_tambah.php\">Kembali</a>";	//membuat Link untuk kembali ke halaman tambah
...
<div class="wrapper row5">
  <div id="copyright" class="clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">CV. Radja Sale</a></p>
    <!-- ################################################################################################ -->
  </div>
</div>
<!-- ################################################################################################ -->
