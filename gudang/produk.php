       ...
       <nav id="mainav" class="fl_right">
          <ul class="clear">
            ...
            <li class="active"><a class="drop" href="#">Data Master</a>
			  ...
			  </li><li><a href="permintaanproduk.php">Permintaan Produk</a></li>
            </li><li><a href="peramalan.php">Peramalan</a></li>
...
<br><!--<div id="pageintro"><a class="btn" href="produk_tambah.php">Tambah Data</a></div>-->
<center>
...
<!-- form quick search -->
<form name="form1" method="post" action="produk_cari.php">
...
if(isset($_POST['q']) && $_POST['q']){
	...
	$q = $_POST['q'];
	$sql = "select * from produk where id_produk like '%$q%' or nama_produk like '%$q%'";
...
<!-- Advance Search -->
 ...
 <!--<td><a href="produk_edit.php?id_produk=<?php echo $buff['id_produk']; ?>">Edit</a><td><a href="produk_hapus_proses.php?id_produk=<?php echo $buff['id_produk']; ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>-->
 </tr>
			<?php }?>
		</table>
		<?php
...
<tr align="center">
 ...
 <td><?php echo $buff['nama_produk']; ?></td>
 <!--<td><a href="produk_edit.php?id_produk=<?php echo $buff['id_produk']; ?>">Edit</a>
 <td><a href="produk_hapus_proses.php?id_produk=<?php echo $buff['id_produk']; ?>" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>-->
 </tr>
